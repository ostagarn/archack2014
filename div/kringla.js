...
var divKoden = '<h2>VERIFIERA DENNA PERSON I LIBRIS!</h2><p>Libris:&nbsp;<a href="http://libris.kb.se/auth/175511">Gunnar Asplund</a></p>';
divKoden += 'Är detta samma person? <form>Ja:<input type="radio" /> nej:<input type="radio"/>&nbsp;';
divKoden += '<input style="font: 0.71em Verdana, Tahoma, Helvetica, Sans-Serif;" type="submit" value="Spara"/> </form>';
